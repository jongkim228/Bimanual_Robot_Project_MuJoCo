...
def main() -> None:
    ...
    with mujoco.viewer.launch_passive(
        ...
        mujoco.mj_forward(model, data)
        q_check = np.zeros(4)
        mujoco.mju_mat2Quat(q_check, data.site(site_id).xmat)
        ...
        while viewer.is_running():
            ...
            dq += (eye - np.linalg.pinv(jac_sub) @ jac_sub) @ (Kn * (q0[dof_ids] - data.qpos[dof_ids]))
            ...
            q[dof_ids] = q[dof_ids] + dq * integration_dt
